<template>
    <span>
        ...
        <v-toolbar app color="brown darken-4" dark>
            ...
            <v-btn flat class="hidden-sm-and-down nav-menu" to="/menu" data-cy="menuBtn">Parking Availability Status</v-btn>
...
export default {
    ...
    data() {
        return {
            appTitle: 'Utrecht Car Parking Notification',
            drawer: false,
            items: [
                { title: 'Parking Availablity Status', icon: 'dashboard'},
                { title: 'Sign In' },
                { title: 'Join' }
                ]
        };
